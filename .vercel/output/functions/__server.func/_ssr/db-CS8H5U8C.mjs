...
//#region node_modules/.nitro/vite/services/ssr/assets/db-CS8H5U8C.js
var db_CS8H5U8C_exports = /* @__PURE__ */ __exportAll({
	i: () => getSql,
	n: () => ensureDbReady,
	r: () => getPglite,
	t: () => db_exports
...
async function createPgliteSql() {
	globalRef.__pgliteInstance__ ??= (async () => {
		...
		const pg = new PGlite(PGLITE_DIR, { parsers: {
			[OID_INT8]: Number,
			[OID_DATE]: identity,
		...
		const timer = setInterval(flush, 2e3);
...
//#endregion
export { getSql as i, ensureDbReady as n, getPglite as r, db_CS8H5U8C_exports as t };
