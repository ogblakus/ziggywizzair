import { a as missedWhyOpened, c as gateCouncilOrder, l as markOf, n as isWhyOpenedQuestion, o as replyLocale, r as localAsk, s as clipPctOf, t as isEnglishLeak, u as qtyForClip } from "./local-council-BdVu5uQG.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/council-DxQ8UIeG.js
var AGENTS = [
	"vesper",
	"ash",
	"kai",
...
var askFloor = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator((input) => input).handler(askFloor_createServerFn_handler, async ({ context, data }) => {
	...
	try {
		...
		const raw = extractJson(await chat(`${langBlock(locale, "ask")}
