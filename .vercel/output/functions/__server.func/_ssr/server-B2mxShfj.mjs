...
import { A as runWithRequestState, B as getAuthTables, C as isAPIError, D as runWithTransaction, E as runWithAdapter, Et as JWTExpired, F as toResponse, G as jwtVerify, Gt as email, H as decodeJwt, Ht as any, I as serializeCookie, Jt as number, L as serializeSignedCookie, M as runWithEndpointContext, N as getBetterAuthVersion, O as defineRequestState, P as createRouter$1, Qt as string, R as safeJSONParse, Rt as base64Url, S as createAuthMiddleware, Sn as isTest, T as queueAfterTransactionHook, U as decodeProtectedHeader, Ut as array, V as createRandomStringGenerator, W as importJWK, Wt as boolean, Xt as optional, Yt as object, Zt as record, _ as createRateLimitKey, _n as env, a as socialProviders, b as deprecate, bn as isDevelopment, c as createAuthorizationURL, cn as APIError, d as generateId, dn as BASE_ERROR_CODES, f as withSpan, g as import_src, h as ATTR_OPERATION_ID, hn as shouldPublishLog, i as SocialProviderListEnum, in as betterFetch, j as getCurrentAuthContext, k as hasRequestState, l as applyDefaultAccessTokenExpiry, ln as BetterAuthError, m as ATTR_HOOK_TYPE, mn as logger, mt as encode, n as initGetModelName, o as validateAuthorizationCode, p as ATTR_CONTEXT, pn as createLogger, qt as looseObject, r as initGetFieldName, s as refreshAccessToken, sn as normalizePathname, u as isLoopbackHost, un as kAPIErrorHeaderSymbol, v as findInvalidTrustedProxies, w as getCurrentAdapter, x as createAuthEndpoint, xn as isProduction, y as getIp, z as filterOutputFields } from "../_libs/@better-auth/core+[...].mjs";
import { a as getOrigin, c as isRequestLike, i as getHost, l as resolveBaseURL, n as PACKAGE_VERSION, o as getProtocol, r as getBaseURL, s as isDynamicBaseURLConfig, t as GENERIC_OAUTH_ERROR_CODES, u as wildcardMatch } from "./error-codes-DDKTvJVl.mjs";
...
import { a as verifyPassword$1, i as symmetricEncrypt, n as hashPassword$1, r as symmetricDecrypt } from "./crypto-45IVpPEN.mjs";
import { n as ensureDbReady, r as getPglite } from "./db-By3YCc4B.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/dist-CcyjE30g.js
...
var dist_exports = /* @__PURE__ */ __exportAll({ APIError: () => APIError });
//#endregion
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-B2mxShfj.js
		...
		hooks: { after: [{
			...
			handler: createAuthMiddleware(async (ctx) => {
				...
				if (returned instanceof Headers) {
					...
					const { setCookie } = await import("./server-BxuBBDLK.mjs").then((n) => n.i).then((n) => n.t);
...
var auth = betterAuth({
	...
	databaseHooks: { user: { create: {
		async before(user) {
			...
			const { HANDLE_EMAIL_DOMAIN } = await import("./login-handle-CKSdUz3G.mjs");
			const { usernameError } = await import("./profile-server-RnW0amzK.mjs").then((n) => n.i);
			const suffix = `@${HANDLE_EMAIL_DOMAIN}`;
			if (email.endsWith(suffix)) {
				if (usernameError(email.slice(0, -suffix.length))) {
					const { APIError } = await import("../_libs/_.mjs").then((n) => n.t);
					throw new APIError("BAD_REQUEST", { message: "Invalid handle" });
				}
			}
			return { data: {
				...user,
		...
		async after() {
			try {
				...
				await snapshotVault(await getSql());
			} catch {}
		}
	} } },
	advanced: {
...
//#endregion
export { resolveRequestContext as A, isPromise as C, parseState as D, parseSetCookieHeader as E, setSessionCookie as F, setTokenUtil as I, toCookieOptions as L, runPluginInit as M, sessionMiddleware as N, redirectOnError as O, setRequestCookie as P, hasServerSessionStore as S, missingEmailLogMessage as T, getInternalPlugins as _, hasGateSessionMarker as a, getTrustedProviders as b, applyUpdateUserInfoOnLink as c, createCookieGetter as d, createInternalAdapter as f, getEndpoints as g, getCookies as h, gateIdentityEnabled as i, router as j, resolveDynamicTrustedProxyHeaders as k, checkEndpointConflicts as l, generateState as m, authConfigured as n, GROK_PROVIDERS as o, dist_exports as p, server_exports as r, HIDE_METADATA as s, auth as t, checkPassword as u, getSessionFromCtx as v, matchesOriginPattern as w, handleOAuthUserInfo as x, getTrustedOrigins as y };
