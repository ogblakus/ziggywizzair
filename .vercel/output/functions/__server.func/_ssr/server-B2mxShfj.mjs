...
import { A as runWithRequestState, At as encode, C as isAPIError, D as runWithTransaction, E as runWithAdapter, F as toResponse, G as email, H as any, Ht as JWTExpired, I as serializeCookie, J as number, L as serializeSignedCookie, M as runWithEndpointContext, N as getBetterAuthVersion, O as defineRequestState, P as createRouter$1, Q as string, R as safeJSONParse, S as createAuthMiddleware, T as queueAfterTransactionHook, U as array, W as boolean, X as optional, Y as object, Z as record, _ as createRateLimitKey, a as socialProviders, at as decodeProtectedHeader, b as deprecate, bn as isProduction, c as createAuthorizationURL, cn as BetterAuthError, d as generateId, en as base64Url, f as withSpan, fn as createLogger, g as import_src, gn as env, h as ATTR_OPERATION_ID, i as SocialProviderListEnum, it as decodeJwt, j as getCurrentAuthContext, k as hasRequestState, l as applyDefaultAccessTokenExpiry, ln as kAPIErrorHeaderSymbol, m as ATTR_HOOK_TYPE, mn as shouldPublishLog, n as initGetModelName, nt as getAuthTables, o as validateAuthorizationCode, on as normalizePathname, ot as importJWK, p as ATTR_CONTEXT, pn as logger, q as looseObject, r as initGetFieldName, rn as betterFetch, rt as createRandomStringGenerator, s as refreshAccessToken, sn as APIError, st as jwtVerify, u as isLoopbackHost, un as BASE_ERROR_CODES, v as findInvalidTrustedProxies, w as getCurrentAdapter, x as createAuthEndpoint, xn as isTest, y as getIp, yn as isDevelopment, z as filterOutputFields } from "../_libs/@better-auth/core+[...].mjs";
