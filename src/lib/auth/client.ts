...
const BEARER_STAY_KEY = "grok-auth.stay";
...
function storageSet(store: Storage, key: string, value: string | null) {
  try {
...
export function persistBearer(token: string | null, stay = true): void {
